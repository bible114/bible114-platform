...
- [x] Step 5 — subgroupId ID/Name 분리 (2026-04-30, 빌드 ✓, 하위 호환 유지)
- [x] Step 6 — 디자인 토큰 / Tailwind 확장 (2026-04-30, 빌드 ✓)
- [x] Step 7 — LoginView 디자인 적용 (2026-04-30, 빌드 ✓, 568줄, 기존 인증 로직 보존)
