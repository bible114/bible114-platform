                                ...
                                <div key={member.uid} className={`p-3 rounded-xl border ${isMe ? 'bg-blue-50 border-blue-200' : 'bg-slate-50 border-slate-100'}`}>
                                    <div className="flex items-center justify-between mb-2">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {getYearCompletedRounds(member) > 0 && <span className="text-[10px] bg-purple-500 text-white px-1.5 py-0.5 rounded-full font-bold">올해 {getYearCompletedRounds(member)}독 완료</span>}
