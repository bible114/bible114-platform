...
const MEMBER_FAQ_ITEMS = [
    {
        question: '로그인이 안 돼요',
        answer: <>처음 화면에서 전에 사용한 <strong>카카오 또는 구글</strong> 버튼을 누르세요. 예전에 이름·생년월일·비밀번호로 로그인했다면, 소셜 로그인 뒤 <strong>기존 진도·달란트 이어보기</strong>를 눌러 기존 정보를 한 번 확인하면 다음부터는 소셜 버튼만으로 로그인할 수 있어요. 로그인 없이 둘러본 기록은 이 휴대폰에만 남아요.</>,
    },
    {
        question: '비밀번호를 잊었어요',
        answer: <>비밀번호는 예전 기록을 소셜 계정에 처음 연결할 때만 필요해요. 처음 화면의 <strong>로그인·기록 문의</strong>를 누르거나 교회 관리자(담당 선생님)에게 새 비밀번호를 요청한 뒤 연결해주세요.</>,
    },
    {
