...
const STEPS = [
    {
        ...
        emoji: '📚',
        title: '읽는 버전 바꾸기',
        text: '현재 통독 계획과 성경 버전이 표시돼요.\n탭하면 개역개정과 새번역, 일년일독과 신약일독을 바꿀 수 있어요. 중간에 바꿔도 진도는 그대로 유지됩니다!',
        position: 'below',
    },
    {
        id: 'tut-streak',
    ...
    },
    {
        ...
        warning: '⚠️ 화살표로 다른 날 본문을 보더라도 읽음 처리는 되지 않아요. 살펴보는 중에는 "내 진도로 돌아가기"를 누른 뒤 완료해주세요!',
        position: 'below',
    },
    {
        id: 'tut-font-size',
    ...
    },
    {
        ...
        emoji: '🧩',
        title: '오늘의 퀴즈 (선택)',
        text: '원하면 오늘 본문 퀴즈에 도전해보세요.\n퀴즈를 풀거나 건너뛰지 않아도 읽기 완료와 다음 DAY 진행은 언제든 가능합니다!',
        position: 'above',
    },
    {
        id: 'tut-read-btn',
        emoji: '✅',
        title: '읽기 완료 버튼',
        text: '눈으로 읽거나 듣기를 마쳤으면 이 버튼을 눌러주세요!\n퀴즈 참여 여부와 관계없이 읽기 기록이 저장되고 다음 DAY로 진행합니다. 하루 첫 완료에는 기본 10점과 연속 읽기 보너스(최대 +5점)가 쌓여요!',
        position: 'above',
    },
    {
        id: 'tut-memo-section',
