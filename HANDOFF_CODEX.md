...
| 2026-07-11 | T28 부분 — 누가복음 14장 문항 | `src/data/quiz/luke.json`, `HANDOFF_CODEX.md` | 신약일독 세그먼트 기준 누가복음 14:1-14, 14:15-35 범위 각 5문항(총 10문항) 추가(`luke.json` 총 154문항). Day 216-217 pool 5/5 확인 필요. `node scripts/validate-quiz.mjs`, `npm run build` 통과. 퀴즈 문항 신학적 검수는 사용자 몫. T28 전체 90일 커버리지는 아직 미완료. |
...
- T28 진행 중. 누가복음 14:1-14, 14:15-35 세그먼트에 각 5문항을 추가해 `luke.json`은 총 154문항이 됐다. 다음 우선순위는 누가복음 15장 세그먼트 계속 저작이다. 퀴즈 문항 신학적 검수는 사용자 몫이다.
...
- [ ] **T33. 퀴즈 우선 게이트 — 퀴즈를 확인해야 "오늘 읽기 완료" 활성화** (T29 완료 후 착수 — 같은 버튼 영역)
